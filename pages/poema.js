...
export function Poema() {
  ...
  async function gerarReceita() {
    ...
    const prompt = `Crie um poema detalhada de modo ${ocasiao} com ${ingr4} estrofes, usando as informações: ${ingr1}, ${ingr2}, ${ingr3} e pesquise autores parecidos que produzem algo do gênero.`;
  ...
  return (
    <View style={ESTILOS.container}>
      ...
      <Text style={ESTILOS.header}>Gerador de Poema</Text>
      <View style={ESTILOS.form}>
        ...
        />
        <TextInput
          placeholder="Quant. de Estrofes"
          style={ESTILOS.input}
          value={ingr4}
          onChangeText={(texto) => defIngr4(texto)}
        />
        <TextInput
          placeholder="Formal ou Informal"
          style={ESTILOS.input}
          value={ocasiao}
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24, marginTop: 4, }} style={ESTILOS.containerScroll} showsVerticalScrollIndicator={false} >
        {load && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Produzindo poema...</Text>
        ...
        {receita && (
          <View style={ESTILOS.content}>
            <Text style={ESTILOS.title}>Seu poema 👇</Text>
